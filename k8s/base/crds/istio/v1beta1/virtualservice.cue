	...
	spec?: {
		...
		http?: [...{
			...
			corsPolicy?: {
				...
				allowOrigins?: [...matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					exact!: _
				...
				// Indicates whether preflight requests not matching the
				// configured allowed origin shouldn't be forwarded to the
				// upstream.
				//
			...
			directResponse?: {
				...
				body?: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					string!: _
				}, null | bool | number | string | [...] | {
					bytes!: _
				}])]) & {}, {
			...
			fault?: {
				...
				// service is faulty.
				abort?: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					httpStatus!: _
				}, null | bool | number | string | [...] | {
					grpcStatus!: _
				}, null | bool | number | string | [...] | {
					...
					httpStatus?: int32 & int

					// Percentage of requests to be aborted with the error code
					// provided.
				...
				delay?: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					fixedDelay!: _
				}, null | bool | number | string | [...] | {
					exponentialDelay!: _
				}])]) & {}, {
			...
			match?: [...{
				...
				// separator, e.g.
				headers?: [string]: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					exact!: _
				}, null | bool | number | string | [...] | {
					prefix!: _
				}, null | bool | number | string | [...] | {
				...
				queryParams?: [string]: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					exact!: _
				}, null | bool | number | string | [...] | {
					prefix!: _
				}, null | bool | number | string | [...] | {
				...
				// opposite meaning.
				withoutHeaders?: [string]: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
					exact!: _
				}, null | bool | number | string | [...] | {
					prefix!: _
				}, null | bool | number | string | [...] | {
			...
			mirrors?: [...{
				...
				// Percentage of the traffic to be mirrored by the `destination`
				// field.
				percentage?: value?: number
			}]
			...
			// A HTTP rule can either return a direct_response, redirect or
			// forward (default) traffic.
			redirect?: matchN(1, [matchN(0, [matchN(>=1, [null | bool | number | string | [...] | {
				port!: _
			}, null | bool | number | string | [...] | {
				derivePort!: _
			}])]) & {}, {
			...
			retries?: {
				...
				// Flag to specify whether the retries should ignore previously
				// tried hosts during retry.
